...
public class MenuFragment extends Fragment {
    ...
    public MenuFragment(int numberOfItems, Context context){
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Log.d("MenuFragment-onViewCreated", "view have to be created");
        rv = (RecyclerView) requireView().findViewById(R.id.ResView);
        Log.d("MenuFragment-onViewCreated", rv == null ? "null": "not null");
